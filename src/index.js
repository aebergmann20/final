...
var base = Rebase.createClass({
  apiKey: "AIzaSyCWGQmQz_C4AX2Tmgc1HoQl9mRbfNZm1vI",   // replace with your Firebase application's API key
  databaseURL: "https://final-86874.firebaseio.com", // replace with your Firebase application's database URL
})
...
var App = React.createClass({
  ...
  viewChanged: function(view) {
    ...
    // You should really look at https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/sort
      // if (view === 'latest') {
        // this.setState({
        // return <movies: this.state.movies.sort(this.movieCompareByReleased) />
        // currentView: view
    //  })
    //}  else if (view === 'alpha') {
      // this.setState({
        // return <movies: this.state.movies.sort(this.movieComparedByTitle) />
        // currentView: view
        // })
      // } else if (view === 'map') {
        // this.setState({
